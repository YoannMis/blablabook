...
const LibraryPopoverShell = ({ title, subtitle, children }: LibraryPopoverShellProps) => (
  <Popover.Content
  ...
  >
    <Box px={4} pt={4} pb={3}>
      <Box fontWeight="semibold" fontSize="md" fontFamily="heading" color={{ _dark: 'light.100' }}>
        {title}
      </Box>
